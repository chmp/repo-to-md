...
This document tracks potential enhancements and optimizations for review-to-md that are not part of the current implementation.
...
- Natural workflow: `/review-pr 1` → Claude creates plan → User approves → Claude addresses
...
- ~~Filter Options (--file, --user)~~ - Will be superseded by GraphQL API migration
